...
//     [X] can rebalance even if TRSRY hold less than FUND_AMOUNT.
// [X] sweepIntoDSR
...
contract ClearinghouseFuzzTest is Test {
    ...
    function testFuzz_rebalance_pullFunds_withSmallTRSRY(uint256 daiLent_, uint256 sdaiTRSRY_) public {
        // Newly lent assets cannot exceed Clearinghouse funding
        daiLent_ = bound(daiLent_, 0, clearinghouse.FUND_AMOUNT());
