...
//     // function testFuzz_extendLoan_repayingInterest(uint256 loanAmount_) public {
//     //     // Loan amount cannot exceed Clearinghouse funding
...
//     //     uint256 repay = initLoan.principle - initLoan.request.amount;
...
//     //     assertEq(newLoan.amount, initLoan.principle);
...
//         vm.prank(others);
//         vm.expectRevert(CoolerCallback.OnlyFromFactory.selector);
//         clearinghouse.extendLoan(maliciousCooler, 0);
//     }
...
//         // Check: clearinghouse storage
//         assertEq(clearinghouse.interestReceivables(), initReceivables - repay);
//         assertApproxEqAbs(clearinghouse.interestReceivables(), cooler.getLoan(loanID).principle, 1e4);
//     }
